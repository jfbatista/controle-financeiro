...
let CategoriesController = class CategoriesController {
    ...
    findAll(user) {
        const allowed = [
            permissions_1.Permission.CATEGORY_VIEW,
...
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.RequirePermissions)(permissions_1.Permission.CATEGORY_CREATE),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, permissions_decorator_1.RequirePermissions)(permissions_1.Permission.CATEGORY_EDIT),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)(permissions_1.Permission.CATEGORY_DELETE),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
